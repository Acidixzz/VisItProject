...
Usage:
  python image_pipeline.py luffy.jpg
  python image_pipeline.py luffy.jpg --step 2 --z-scale 2.0 --depth-model base
  python image_pipeline.py luffy.jpg --skip-sidecars --no-view
"""
...
def view_mesh(vtk_path, image_path, flip_v=False):
    ...
    if not renderer:
        raise FileNotFoundError("C++ viewer not found. Build in WSL: cd cpp && ./build.sh")
